            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Affichage des Patients</h4>
                    </div>
                                                                    ...
                                                                    <form class="form form-vertical" method="post" action="modifierPatient.php">
                                                                        <div class="form-body">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    <div class="form-group">
                                                                                        <label for="mdp-id-vertical">Mot de passe</label>
                                                                                        <input type="text" id="mdp-id-vertical" class="form-control" name="mdpasse" placeholder="mdp" value=<?= $t->get("m") ?>>
                                                                                    </div>
                                                                                    <br>
                                                                                </div>
