            ...
            <div class="sidebar-wrapper active" style="left:0; background-color: #f5faff;">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="../dashboard.php"><img src="../assets/images/logo/kisspng-web-development-e-commerce-logo-electronic-busines-ecommerce-5ad142afc13966.5141508215236635357915.pngalt=" Logo" srcset="" style="margin-top: 4px;"></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="http://localhost/Mini/Presentation/Fournisseur/ajouterFournisseur.php">Ajout</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="http://localhost/Mini/Presentation/Fournisseur/afficherFournisseurs.php">Liste</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item  has-sub">
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2022/2023 &copy; MOHAMMED EL BADRY - ESTS</p>
                    </div>
                </div>
            </footer>
        </div>
